# maia
Prototipo per la costruzione di un sistema elettronico digitale di controllo per la misurazione di peso e temperatura per il monitoraggio e telecontrollo di arnie  
#### Ingredienti:
